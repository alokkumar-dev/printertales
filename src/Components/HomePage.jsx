    ...
    <div className="homeContainer">
      ...
      <div className="affiliate-section">
        ...
        <p className="affiliate-desc">
          ...
          brand&rsquo;s printer. Printer Tales is not related to any of these
          brands in any way. Our only relationship is with our customers who use
          the information on our website to resolve their printer problems. The
